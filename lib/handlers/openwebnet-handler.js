...
class OpenwebnetHandler {
    ...
    handle(listener, system, msg) {
        ...
        switch (msg) {
            case msg.startsWith('*8*19*21') ? msg : undefined:
                ...
                break
            case msg.startsWith('*8*20*21') ? msg : undefined:
                setTimeout(() => {
                    this.#mqtt.dispatchMessage(msg)
                    this.#mqtt.dispatchLockEvent(msg)
                ...
                break
            case msg.startsWith('*8*1#5#4#21*111##') ? msg : undefined:
                ...
                break
            case msg.startsWith('*8*1#1#4#21*111##') ? msg : undefined:
